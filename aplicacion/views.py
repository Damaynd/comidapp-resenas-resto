...
def index(request):
    ...
    return render(request, "index.html", {"restaurantes": lista_restaurantes})


# Cuando haces click en un restaurante de index.html, esta funcion te llevara a detalle_restaurante.html para ver mas detalles
